...
const TeamsBanner = () => {
  return (
    ...
    >
        <div className='container mt-24 md:mt-32 ml-10 py-10 px-6 bg-[rgba(0,0,0,0.7)] w-full md:w-2/3'>
            ...
            <p className='text-white w-full md:w-2/3 mt-3 text-gray-300'>CeraTattva stands solid on the strong pillars of integrity, intellectuality, innovation, and indigenization. Our exceptional Team brings in outstanding expertise and years of extensive experience curating best of products and services. We take immense pride in our diverse and highly abled Team.</p>
