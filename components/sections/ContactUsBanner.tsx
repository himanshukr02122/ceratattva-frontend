...
const ContactUsBanner = () => {
  return (
    <section 
        className='h-[500px] sm:h-[600px] md:h-[700px] 3xl:h-[1000px] bg-fixed flex items-start pt-20 pb-12 lg:pb-16 3xl:pt-52 3xl:pb-32 bg-no-repeat shadow-lg bg-cover bg-white relative bg-[url("/contact-us.jpg")] bg-center bg-no-repeat after:content-[""] after:absolute after:w-full after:h-full after:bg-[rgba(0,0,0,0.6)] after:top-0 after:left-0'
    >
        <div className='container mx-auto px-2 z-[9]'>
            ...
            <div className='mt-40 bg-[rgba(0,0,0,0.8)] px-6 py-10'>
                <div className='flex items-center gap-2'>
                    <div className='relative w-16 h-16 bg-white m-2'>
                        <Image 
