...
const QuoteBanner = () => {
  return (
    ...
    >
      <div className='group relative z-[9] container mt-24 md:mt-32 sm:ml-10 py-10 3xl:py-16 px-2 sm:px-6 bg-[rgba(0,0,0,0.7)] hover:bg-[rgba(0,0,0,0.6)] w-full md:w-2/3'>
